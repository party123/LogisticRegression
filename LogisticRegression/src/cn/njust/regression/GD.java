...
public class GD {
	...
	public static void main(String[] args) throws IOException {
		...
		Node thetaNode = regressionGD(ex4List);
		// 画直线
	 ...
	 * @return
	 */
	public static Node regressionGD(List<DataNode> nodelist) {
		double theta0 = 0.0;
		double theta1 = 0.0;
		double theta2 = 0.0;
...
//		 double e = 0.1;
		...
		do {
			...
			for (int i = 0; i < n; i++) {
				...
				sumx0 += (ytemp - htemp) * x0temp;
				sumx1 += (ytemp - htemp) * x1temp;
				sumx2 += (ytemp - htemp) * x2temp;
				jtemp += -(ytemp * Math.log(htemp) + (1 - ytemp)* Math.log((1 - htemp)));
			}
			theta0 = theta0 + a * sumx0 / n;
			theta1 = theta1 + a * sumx1 / n;
			theta2 = theta2 + a * sumx2 / n;
...
//			j = jtemp;
	 ...
	 * @return
	 */
	 public static Node reoperate2(Node theta,double xmean1,double xstd1,double xmean2,double xstd2) {
	 double theta0 = theta.getX0();
	 double theta1 = theta.getX1();
	 double theta2=theta.getX2();
	 double newtheta0 = theta0 - (theta1 * xmean1) / xstd1-(theta2 * xmean2) / xstd2;
